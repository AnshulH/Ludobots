...
def Generate_Brain():
    ...
    for source in [0, 1, 2]:
        for motor in [3, 4]:
            pyrosim.Send_Synapse( sourceNeuronName = source , targetNeuronName = motor , weight = random.uniform(-1,1))
    # pyrosim.Send_Synapse( sourceNeuronName = 1 , targetNeuronName = 3 , weight = 8.0)
